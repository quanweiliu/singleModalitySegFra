...
if __name__ == "__main__":
    ...
    in_channels = 3
    out_channels = 1
    # layer_channels = [64, 128, 256, 512]                  # only 4 layers for now
    # x = torch.randn((8, in_channels, 256, 256))
    x = torch.randn((8, in_channels, 128, 128))

    model = A2FPN(band=in_channels, class_num=out_channels)
    # model = A2FPN(band=in_channels, class_num=out_channels, encoder_channels=layer_channels)
