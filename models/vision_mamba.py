...
class MambaUnet(nn.Module):
    def __init__(self, config, img_size=224, num_classes=6, zero_head=False, vis=False):
        ...
        weight_path = "/home/leo/Semantic_Segmentation/CNNvsTransformerHSI/pretrain_weights/stseg_base.pth"
    ...
    def forward(self, x):
        ...
        # if self.training:
        #     print("xt.shape", logits[0].shape)  # 8, 2, 128, 128
        # else:
        #     print("xv.shape", logits.shape)  # 8, 2, 128, 128
        return logits
