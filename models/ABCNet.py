...
class ABCNet(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.training:
            ...
            # print("feat_out", feat_out.shape, "feat_out16", feat_out16.shape, "feat_out32", feat_out32.shape)
            return torch.sigmoid(feat_out), torch.sigmoid(feat_out16), torch.sigmoid(feat_out32)
