...
def ft_unetformer_hsi(pretrained=True, num_classes=6, freeze_stages=-1, decoder_channels=256,
                  weight_path='pretrain_weights/stseg_base.pth'):
    model = FTUNetFormer(num_classes=num_classes,
                         freeze_stages=freeze_stages,
                         embed_dim=128,
...
if __name__ == "__main__":
    ...
    # net = ft_unetformer(num_classes=1, weight_path="/home/leo/Semantic_Segmentation/CNNvsTransformerHSI/pretrain_weights/stseg_base.pth")
    net = ft_unetformer_hsi(num_classes=1, weight_path="/home/leo/Semantic_Segmentation/CNNvsTransformerHSI/pretrain_weights/stseg_base.pth")
    out = net(in_ten)
